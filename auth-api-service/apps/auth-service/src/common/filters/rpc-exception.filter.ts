...
/**
 * Filtro global del microservicio de Auth. En el transporte TCP una HttpException
 * lanzada dentro de un handler NO conserva su código de estado (Nest la reporta como
 ...
 * código HTTP correcto (mismo patrón que usa product-service).
 */
@Catch()
